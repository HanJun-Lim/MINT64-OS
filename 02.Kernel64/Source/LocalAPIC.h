...
// ***** Below Macros for ICR (Interupt Command Register) *****
...
// ***** Below Macros for Local Vector Table *****
// Local Vector Table consists of
// 		- Timer Register
// 		- LINT0/1 Register
// 		- Performance Monitoring Counter Register
