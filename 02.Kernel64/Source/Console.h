...
// Setting Width, Height, Start Addr of Video Memory
#define CONSOLE_WIDTH						80
#define	CONSOLE_HEIGHT						25
#define CONSOLE_VIDEOMEMORYADDRESS			0xB8000


// I/O Port Address, Register of Video Controller
...
// Key Queue Max Count (used in Graphic Mode)
...
typedef struct kConsoleManagerStruct
{
	...
	// the Address of Screen Buffer to print
	CHARACTER* pstScreenBuffer;

	// Key Queue, Mutex for Graphic Mode (GUI Console Shell)
